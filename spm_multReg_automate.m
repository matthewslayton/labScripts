...
for counter = 1:n
    ...
    subj_folder = strcat(path_main, '/FA_results/',subj,'_betas_SPM/');
    mkdir(subj_folder);
    ...
    for f = 1:10
        ...
        %keyboard
        factors = load([path_main '/FA_results/factor_vis_subset_' subj_group '.mat']);
    ...
    %%%%%%%% model estimation
    matlabbatch{counter*2}.spm.stats.fmri_est.spmmat = {strcat(subj_folder, 'SPM.mat')};
