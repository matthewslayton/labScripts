...
for counter = 1:n
    ...
    if counter == 2 %'S005'
        group_counter = 2;
    elseif counter == 8 %'S013'
        group_counter = 3;
    elseif counter == 16 %'S023'
        group_counter = 4;
    end
    subjGroupNum = subject_group{group_counter};
    ...
    for f = 1:10
        ...
        %keyboard
        factors = load(['/Users/matthewslayton/Library/CloudStorage/OneDrive-DukeUniversity/STAMP/FA_results/factor_noTax_subset_' subjGroupNum '.mat']);
        factor_f = factors.(['factor_subset_' subjGroupNum])(:, f); % 300 x 1 double array
    ...
    %matlabbatch{counter*2}.spm.stats.fmri_est.spmmat(1) = cfg_dep(strcat('Factorial design specification: ','/Users/matthewslayton/Library/CloudStorage/OneDrive-DukeUniversity/STAMP/FA_results/',subj,'_betas_SPM/SPM.mat','File'), substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','spmmat'));
