...
addpath('/Users/matthewslayton/Library/CloudStorage/Box-Box/STAMP/STAMP_scripts/');
addpath('/Users/matthewslayton/Library/CloudStorage/Box-Box/STAMP/');
...
% factor analysis
% lambda = factoran(X,m) % X is data and m is number of factors

[lambda,psi,T] = factoran(justFeaturesArray,10);


[lambda,psi,T] = factoran(justFeaturesArray',10);

[lambda,psi,T] = factoran(covMatTransposed,10);
...
[lambda, psi, T, stats, F] = factoran(justFeatureArray(:, 1:nfeatures), m, 'rotate', 'promax');
%%
clc
F_to_examine = 1;
